...
public class Class01_String {
  ...
  public static void method2() {
    ...
    System.out.println(System.identityHashCode(str1)); // 참조
  ...
  public static void method3() {
    ...
    // 문자열 객체는 개발자가 관리한다. -> 동일한 문자열 객체도 여러 개 생성
  ...
  public static void method7() {
    ...
    // indexOf     : 전달한 문자열이 발견된 첫 번쨰 인덱스를 반환, 없으연 -1을 반환
    // lastIndexOf : 전달한 문자열이 발견된 마지막 인덱스를 반환, 없으연 -1을 반환
  ...
  public static void method13() {
    ...
    // split : 지정한 정규식 패턴으로 문자열로 분리한 String[] 을 반환
